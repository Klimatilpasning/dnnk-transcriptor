...
SEED_GLOSSARY = [
    ...
    ("tik talk", "Tech Talk"),
    ("tiktokken", "Tech Talk'en"),
    ("tik toppen", "Tech Talk'en"),
    ("tektuppen", "Tech Talk'en"),
    ("sektuppen", "Tech Talk'en"),
    ("DNDK", "DNNK"),
    ("DNSK", "DNNK"),
    ("danni k", "DNNK"),
    ("Danny k", "DNNK"),
    ("Cornelius Pals", "Kornelius Pagels"),
    ("Cornelius Pahls", "Kornelius Pagels"),
    ("Cornelius pals", "Kornelius Pagels"),
    ("VSP", "WSP"),
    ("Skalgo", "Scalgo"),
    ("skalgo", "Scalgo"),
    ("Skalco", "Scalgo"),
    ("skalco", "Scalgo"),
    ("mike urben", "MIKE URBAN"),
    ("Envidan", "EnviDan"),
    ("Novaos", "Novafos"),
    ("nova-fos", "Novafos"),
    ("real dania", "Realdania"),
    ("svego", "Sweco"),
    ("Svego", "Sweco"),
    ("kysbeskyttelse", "kystbeskyttelse"),
    ("Køstdirektoratet", "Kystdirektoratet"),
    ("video University College", "VIA University College"),
    ("forvirrer University College", "VIA University College"),
]
